...
protected:
    ...
    int     m_TextureXCount;
    int     m_TextureYCount;
    float   m_TextureXSize;
    float   m_TextureYSize;
...
public:
    ...
    ETileOption GetTileOption(const Vector3& Pos);
...
public:
    ...
    void ChangeTileOptionByIdx(int idx, ETileOption Option);

    void TestTileSetZFG();

public :
    void CreateTextureFrameData(int countX, int countY, float sizeX, float sizeY);
    void SetTileArrayData(const std::vector<unsigned int> TileStart);
