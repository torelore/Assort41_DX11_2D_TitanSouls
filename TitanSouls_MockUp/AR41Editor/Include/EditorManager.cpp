...
bool CEditorManager::Init(HINSTANCE hInst)
{
	...
	CSceneInfo* Info = new CTitleScene;
	//CSceneInfo* Info = new CStartingRuinSceneInfo;
	//CSceneInfo* Info = new CKnightSceneInfo;
	//CSceneInfo* Info = new CSlimeSceneInfo;
	//CSceneInfo* Info = new CYetiSceneInfo;
	CScene::AddSceneInfoCDO("TitleScene", Info);
	
	//StartingRuinSceneInfo
	...
	//CSceneManager::GetInst()->CreateSceneInfo<CStartingRuinSceneInfo>();
	//CSceneManager::GetInst()->CreateSceneInfo<CKnightSceneInfo>();
	//CSceneManager::GetInst()->CreateSceneInfo<CSlimeSceneInfo>();
	//CSceneManager::GetInst()->CreateSceneInfo<CYetiSceneInfo>();
